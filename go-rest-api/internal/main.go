...
import (
    ...
    "github.com/gmarking/learning-go/go-rest-api/pkg/swagger/server/restapi"

    "github.com/gmarking/learning-go/go-rest-api/pkg/swagger/server/restapi/operations"
)
...
func GetHelloUser(user operations.GetHelloUserParams) middleware.Responder {
	return operations.NewCheckHealthOK().WithPayload("Hello " + user.User + "!")
}
